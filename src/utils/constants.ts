// APP TEXT
export const APP_TITLE = "Interrobang Cartel - The World's Biggest";
export const APP_DESCRIPTION = 'Interrobang Cartel Web Site';
export const FOOTER_TEXT = `${new Date().getFullYear()} Brought to you by Swedish Glarno!`;
// PAGES TITLE
